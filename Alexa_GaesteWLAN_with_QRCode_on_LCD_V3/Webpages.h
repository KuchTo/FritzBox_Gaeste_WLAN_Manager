...
<head>
<meta charset='utf-8'>
<title>Hauptseite Gaeste WLAN Schalter</title>
<meta name='description' content='Tobis Luxus Gaeste WLAN Schalter - mit Alexa Unterstuetzung'>
...
<body>
<h2>Hauptseite</h2>
<h3>System und Konfigurationseinstellungen:</h3>
%ADMINLINKS%
</body>
</html>
...
<form action="/capi">
  ...
  </div><small>Nach Absenden der TR 64 Protokolldaten ist ein Neustart des Systems notwendig.</small>
</form>
...
String getLocalIPRedir(const String& var){
 ...
 if(var == "ADMINLINKS"){
    String HTMLIPAdress = "";
    StrLocalIPAddr = WiFi.localIP().toString().c_str();
    HTMLIPAdress = "<p><a href='http:\\" + StrLocalIPAddr + char(92) + "tr64' title='Tr64-Configuration'>TR 64 Protokollkonfiguration</a></p>";
    
   HTMLIPAdress += "<p><a href='" + char(92) + "update' title='OTA-Update'>OTA Update</a></p>";
   //  "\update' title='OTA-Update'>OTA Update</a></p>"
    return HTMLIPAdress ;
  }
...
void SetWebPages()
{
  ...
  request->send_P(200, "text/html", index_html,getLocalIPRedir);   
    });
